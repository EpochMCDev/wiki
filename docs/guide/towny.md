...
- **创建城镇**需消耗 **5 万金币**，之后城镇每天缴纳 **1000 金币**维护费。
- **创建国家**需消耗 **20 万金币**（须先成为城镇镇长），之后国家每天缴纳 **5000 金币**维护费。
- **城镇资源升级**（1~4 级）：分别需 **2.5 万 / 10 万 / 50 万 / 120 万金币** 与 **80 / 150 / 350 / 500 区块**，生产效率和人数要求随等级提升。
- 镇长可设置税收：
